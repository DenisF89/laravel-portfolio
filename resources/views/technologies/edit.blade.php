...
@section("content")
    ...
    <form class="form-control my-5" action="{{ route("technologies.update", $technology) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <div class="input-group d-flex" style="max-width:200px;">
                <input type="color" class="form-control form-control-color @error('color') is-invalid @enderror" name="color" id="color" value="{{ old('color', $technology->color) }}">
                @error('color')
